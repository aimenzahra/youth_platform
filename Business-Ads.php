   ...
   if ($result->num_rows > 0) {
    ...
    while($row = mysqli_fetch_array($result))  
      { ?>  
        ...
        <h4 class="mt-2"><?php echo $row['add_title']; ?></h4>

<br>
        <div style="text-align:center;">
          <a href="View-Ad.php?ad=<?php echo $row['add_no']; ?>"><button class="btn" style="background-color: #1A2E35;color: white;">View Ad</button></a>
        </div>
