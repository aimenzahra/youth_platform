...
$query11 = "SELECT * FROM users WHERE email='$email' AND password='$password'";
$result11 = mysqli_query($conn, $query11);  
if ($result11->num_rows > 0) {
 $row= mysqli_fetch_assoc($result11);
 $reg_no=$row['reg_no'];
$_SESSION['session_user']=$reg_no;
 ...
 <div class="row mt-3">
                    ...
                    <div class="col-lg-4 col-md-4 col-12 text-center">
                        <form action="" method="POST">
                            ...
                            <input required type="password" required class="form-control" name="password" placeholder="Enter your password">
