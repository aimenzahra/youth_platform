   ...
   include 'config.php';
   $ad=$_GET['ad'];
   $query = "SELECT * FROM jobs WHERE add_no='$ad'";
...
if(isset($_POST['submit'])){
 ...
 $sql = "INSERT INTO applied(full_name,f_name,cnic,phone,email,education,job_id,address)
...
<div class="col-lg-6 col-md-6 col-12 mt-5" style="padding-bottom: 50px;padding-top: 50px;box-shadow: 10px 10px #1CBBB4;border: 1px solid #1CBBB4;">
  ...
  <div class="row mt-3">
  <div class="col-6 text-right" style="font-weight: bold;">Job Location</div>
  <div class="col-6 text-left"><?php echo $row['job_location']; ?></div>
  </div>

  <div class="row mt-3">
  <div class="col-6 text-right" style="font-weight: bold;">Total Vacansies</div>
  <div class="col-6 text-left"><?php echo $row['t_vacansies']; ?></div>
  </div>


   <div class="row mt-3">
  <div class="col-6 text-right" style="font-weight: bold;">Description</div>
  <div class="col-6 text-left"><?php echo $row['job_desc']; ?></div>
  </div>
